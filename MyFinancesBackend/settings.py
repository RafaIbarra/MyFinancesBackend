...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS=['my-finances-web-git-main-rafaels-projects-2fb6f3d4.vercel.app']
...
if DEBUG:
    ...
    CORS_ORIGIN_WHITELIST=['my-finances-web-git-main-rafaels-projects-2fb6f3d4.vercel.app']
